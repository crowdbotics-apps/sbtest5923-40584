...
export const api_v1_m1_list = createAsyncThunk(
  "m1s/api_v1_m1_list",
  async payload => {
...
export const api_v1_m1_create = createAsyncThunk(
  "m1s/api_v1_m1_create",
  async payload => {
    const response = await apiService.api_v1_m1_create(payload)
    return response.data
  }
)
export const api_v1_m1_retrieve = createAsyncThunk(
  "m1s/api_v1_m1_retrieve",
  async payload => {
    const response = await apiService.api_v1_m1_retrieve(payload)
    return response.data
  }
)
export const api_v1_m1_update = createAsyncThunk(
  "m1s/api_v1_m1_update",
  async payload => {
    const response = await apiService.api_v1_m1_update(payload)
    return response.data
  }
)
export const api_v1_m1_partial_update = createAsyncThunk(
  "m1s/api_v1_m1_partial_update",
  async payload => {
    const response = await apiService.api_v1_m1_partial_update(payload)
    return response.data
  }
)
export const api_v1_m1_destroy = createAsyncThunk(
  "m1s/api_v1_m1_destroy",
  async payload => {
